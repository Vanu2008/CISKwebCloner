# this is made by Vansh Student of CISKullu So pls do not Copy it
import sys
...
try:
    ...
    print("Made BY Vansh A Student Of Cisk:\nhttps://www.cisk.co.in/")
    print("Usage:\npython3 Main.py www.example.com folder_name")
    sys.exit(1)
